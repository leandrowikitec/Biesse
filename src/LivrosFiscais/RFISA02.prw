...
*/
			...
			For nLoop := 1 To Len(aDados)
				...
				Else
					aAdd(aErros, "Produto nใo cadastrado. O produto " + aDados[nLoop][1] + " nใo foi cadastrado no relacionamento Produto x Fornecedor para o fornecedor" + cCodFor + " - " + AllTrim(SA2->A2_NOME) + ".")
				EndIf
			Next nLoop
